...
from salted.selection_functions import do_fps
from salted.selection_functions import do_rand
from salted.selection_functions import do_CUR
...
def build():
    ...
    # compute sparse set
    fps_idx = np.array(do_rand(power.reshape(ndata*natmax,nfeat),M),int)
